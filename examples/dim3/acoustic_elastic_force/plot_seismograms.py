...
def plot_component_group(stations_sorted, component_group, output_filename):
    ...
    for component in components:
        for time, amplitude in component_group[component].values():
    ...
    for i, component in enumerate(components):
        ...
        for j, station in enumerate(stations_sorted):
            ...
            if station_name not in seismograms:
                continue
...
def main():
    ...
    plot_component_group(
        stations_sorted, displacement, "OUTPUT_FILES/displacement_seismograms.png"
    )
    plot_component_group(
        stations_sorted, velocity, "OUTPUT_FILES/velocity_seismograms.png"
    )
    plot_component_group(
        stations_sorted, acceleration, "OUTPUT_FILES/acceleration_seismograms.png"
    )
    plot_component_group(
        stations_sorted, pressure, "OUTPUT_FILES/pressure_seismograms.png"
    )

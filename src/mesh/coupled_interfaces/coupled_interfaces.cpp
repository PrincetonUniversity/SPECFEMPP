...
specfem::mesh::coupled_interfaces coupled_interfaces(
    specfem::mesh::interface_container<
        ...
        specfem::element::medium_tag::acoustic> elastic_acoustic,
    specfem::mesh::interface_container<
        specfem::element::medium_tag::acoustic,
        specfem::element::medium_tag::poroelastic> acoustic_poroelastic,
    specfem::mesh::interface_container<
        specfem::element::medium_tag::elastic,
        specfem::element::medium_tag::poroelastic> elastic_poroelastic) {

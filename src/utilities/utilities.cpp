...
//   s_coorg("get_best_location::s_coorg",
//                                                  ndim, ngnod);
...
// specfem::utilities::locate(const specfem::kokkos::HostView2d<type_real>
// coord,
//                            const specfem::kokkos::HostMirror3d<int> ibool,
//                            const specfem::kokkos::HostMirror1d<type_real>
//                            xigll, const
//                            specfem::kokkos::HostMirror1d<type_real> zigll,
//                            const int nproc, const type_real x_source,
//                            const type_real z_source,
//                            const specfem::kokkos::HostView2d<type_real>
//                            coorg, const specfem::kokkos::HostView2d<int>
//                            knods, const int npgeo, const specfem::MPI::MPI
//                            *mpi) {
...
//       std::tie(xi, gamma) =
//           get_best_location(x_source, z_source, coorg, xi, gamma, knods,
//           ispec);
...
// void specfem::utilities::check_locations(const type_real x, const type_real
// z,
...
bool specfem::utilities::almost_equal(const type_real computed_value,
                                      const type_real ref_value,
                                      const type_real tol) {
  return std::abs(computed_value - ref_value) < tol;
}

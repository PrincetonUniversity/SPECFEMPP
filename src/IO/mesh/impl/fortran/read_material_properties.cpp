...
std::vector<specfem::mesh::materials::material_specification> read_materials(
    ...
    specfem::mesh::materials::material<elastic_sh, isotropic>
    ...
    specfem::mesh::materials::material<elastic_sh, anisotropic>
  ...
  assert((l_elastic_sv_isotropic.size() + l_elastic_sh_isotropic.size() +
          ...
          l_elastic_sh_anisotropic.size()) == numat);

  elastic_sv_isotropic =
      specfem::mesh::materials::material<elastic_sv, isotropic>(
          l_elastic_sv_isotropic.size(), l_elastic_sv_isotropic);

  elastic_sh_isotropic =
      specfem::mesh::materials::material<elastic_sh, isotropic>(
          l_elastic_sh_isotropic.size(), l_elastic_sh_isotropic);

  elastic_sv_anisotropic =
      specfem::mesh::materials::material<elastic_sv, anisotropic>(
          l_elastic_sv_anisotropic.size(), l_elastic_sv_anisotropic);

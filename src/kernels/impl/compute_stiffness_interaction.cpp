#include "kernels/impl/compute_stiffness_interaction.hpp"
#include "enumerations/material_definitions.hpp"
#include "kernels/impl/compute_stiffness_interaction.tpp"

#define INSTANTIATION_MACRO(DIMENSION_TAG, MEDIUM_TAG, PROPERTY_TAG,           \
                            BOUNDARY_TAG)                                      \
  /** instantiation for NGLL = 5     */                                        \
  template void specfem::kernels::impl::compute_stiffness_interaction<         \

#include "kernels/impl/compute_material_derivatives.hpp"
#include "kernels/impl/compute_material_derivatives.tpp"

#define INSTANTIATION_MACRO(DIMENSION_TAG, MEDIUM_TAG, PROPERTY_TAG)           \
  /** instantiation for NGLL = 5     */                                        \
  template void specfem::kernels::impl::compute_material_derivatives<          \

...
specfem::compute::element_info<containers_type>::element_info(
...
specfem::compute::element_info<containers_type>::get_elements_on_host(
...
specfem::compute::element_info<containers_type>::get_elements_on_device(
    const specfem::element::medium_tag medium) const {
...
template class specfem::compute::element_info<specfem::compute::impl::kernels::material_kernels>;

...
specfem::compute::coupled_interfaces::elastic_acoustic::elastic_acoustic(
    ...
    const specfem::kokkos::HostView1d<specfem::enums::element::type>
        h_ispec_type,
    const specfem::mesh::coupled_interfaces::elastic_acoustic &elastic_acoustic)
    : num_interfaces(elastic_acoustic.num_interfaces),
      elastic_ispec(
  ...
  ASSERT(h_elastic_ispec.extent(0) == num_interfaces, "Invalid elastic_ispec");
  ...
  ASSERT(h_acoustic_edge.extent(0) == num_interfaces, "Invalid acoustic_edge");
...
#ifndef NDEBUG
  check_edges(h_ibool, coord, h_elastic_ispec, h_acoustic_ispec, h_elastic_edge,
              h_acoustic_edge);
#endif
...
specfem::compute::coupled_interfaces::elastic_poroelastic::elastic_poroelastic(
  ...
  compute_edges(h_ibool, h_elastic_ispec, h_poroelastic_ispec, h_elastic_edge,
                h_poroelastic_edge);
...
specfem::compute::coupled_interfaces::acoustic_poroelastic::
  ...
  compute_edges(h_ibool, h_acoustic_ispec, h_poroelastic_ispec, h_acoustic_edge,
                h_poroelastic_edge);
...
specfem::compute::coupled_interfaces::coupled_interfaces::coupled_interfaces(
    ...
    : elastic_acoustic(specfem::compute::coupled_interfaces::elastic_acoustic(
          h_ibool, coord, h_ispec_type, coupled_interfaces.elastic_acoustic)),
      elastic_poroelastic(

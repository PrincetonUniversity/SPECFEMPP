 ...
 * @param xjac host_mirror_type1d where Gauss points (GLL points) will be stored
 ...
 *
 * @param z host_mirror_type1d of GLL points (use gll_utils::jacg to calculate
 * GLL points)
 * @param w host_mirror_type1d where the GLL weights will be stored
 * @param np degree of the Jacobi polynomial
 * @param alpha alpha value of Jacobi polynomial
 * @param beta beta value of Jacobi polynomial
 */

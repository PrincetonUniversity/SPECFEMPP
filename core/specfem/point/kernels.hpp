 ...
 *
 * - Get @f$ K_{\rho} @f$ @code KOKKOS_INLINE_FUNCTION const value_type rho()
 * const @endcode
 * - Get @f$ K_{\mu} @f$ @code KOKKOS_INLINE_FUNCTION const value_type mu()
 * const @endcode
 * - Get @f$ K_{\kappa} @f$ @code KOKKOS_INLINE_FUNCTION const value_type
 * kappa() const @endcode
 * - Get @f$ K_{\rho^\prime} @f$ @code KOKKOS_INLINE_FUNCTION const value_type
 * rhop() const @endcode
 * - Get @f$ K_{\alpha} @f$ @code KOKKOS_INLINE_FUNCTION const value_type
 * alpha() const @endcode
 * - Get @f$ K_{\beta} @f$ @code KOKKOS_INLINE_FUNCTION const value_type beta()
 * const @endcode
 *
 */
template <specfem::element::medium_tag MediumTag, bool UseSIMD>

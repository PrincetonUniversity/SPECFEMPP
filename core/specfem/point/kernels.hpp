 ...
 * double K_beta = 0.4;
 *
 * specfem::point::kernels<specfem::tags::Tags<
 *     dim, medium_tag::elastic_psv, property_tag::isotropic, use_simd>>
...
using kernels = impl::kernels<Tags::dimension_tag, Tags::medium_tag,

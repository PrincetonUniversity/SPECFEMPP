...
template <specfem::element::dimension_tag DimensionTag, int ChunkSize,
          int TileSize, int NumThreads, int VectorLanes, typename SIMD,
...
struct default_chunk_config<specfem::element::dimension_tag::dim3, SIMD,
                            Kokkos::Cuda>
    : chunk_config<specfem::element::dimension_tag::dim3,
                   impl::cuda_chunk_size_3d, impl::cuda_chunk_size_3d, 512, 1,
                   SIMD, Kokkos::Cuda> {};
#endif
...
struct default_chunk_config<specfem::element::dimension_tag::dim2, SIMD,
                            Kokkos::OpenMP>
    : chunk_config<specfem::element::dimension_tag::dim2,
                   impl::openmp_chunk_size, impl::openmp_chunk_size, 1, 1, SIMD,
                   Kokkos::OpenMP> {};
...
struct default_chunk_config<specfem::element::dimension_tag::dim2, SIMD,
                            Kokkos::Serial>
    : chunk_config<specfem::element::dimension_tag::dim2,
                   impl::serial_chunk_size, impl::serial_chunk_size, 1, 1, SIMD,
                   Kokkos::Serial> {};

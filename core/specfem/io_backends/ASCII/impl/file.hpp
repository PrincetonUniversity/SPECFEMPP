...
/**
 * @brief SPECFEM++ ASCII File implementation
 *
 *
...
public:
  ...
  ///@{
  /**
   * @brief Construct a new ASCII File object with the given name
   *
   ...
   * @return specfem::io_backends::impl::ASCII::Dataset<ViewType, OpType>
   * Dataset object
   */
  template <typename ViewType>
  specfem::io_backends::impl::ASCII::Dataset<ViewType, OpType>
   ...
   * @return specfem::io_backends::impl::ASCII::Group<OpType> Group object
   */
  specfem::io_backends::impl::ASCII::Group<OpType>
  createGroup(const std::string &name) {
    return specfem::io_backends::impl::ASCII::Group<OpType>(folder_path, name);
  }
...
public:
  ...
  ///@{
  /**
   * @brief Read the ASCII file with the given name
   *
   * @param name Name of the folder
   */
  File(const std::string &name) : folder_path(name) {

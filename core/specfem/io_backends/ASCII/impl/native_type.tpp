...
namespace specfem::io_backends::impl::ASCII {
...
template <> struct specfem::io_backends::impl::ASCII::native_type<bool> {
  ...
  static void read(std::ifstream &is, bool &value) {
    std::string line;
    std::getline(is, line);
    value = specfem::io_backends::impl::ASCII::safe_parser<bool>(
        line,
        [](const std::string &str) { return str == "1" || str == "true"; });
  }
};

template <> struct specfem::io_backends::impl::ASCII::native_type<unsigned short> {
  ...
  static void read(std::ifstream &is, unsigned short &value) {
    std::string line;
    std::getline(is, line);
    value = specfem::io_backends::impl::ASCII::safe_parser<unsigned short>(
        line, [](const std::string &str) { return std::stoul(str); });
  }
};

template <> struct specfem::io_backends::impl::ASCII::native_type<short> {
  ...
  static void read(std::ifstream &is, short &value) {
    std::string line;
    std::getline(is, line);
    value = specfem::io_backends::impl::ASCII::safe_parser<short>(
        line, [](const std::string &str) { return std::stoi(str); });
  }
};

template <> struct specfem::io_backends::impl::ASCII::native_type<int> {
  ...
  static void read(std::ifstream &is, int &value) {
    std::string line;
    std::getline(is, line);
    value = specfem::io_backends::impl::ASCII::safe_parser<int>(
        line, [](const std::string &str) { return std::stoi(str); });
  }
};

template <> struct specfem::io_backends::impl::ASCII::native_type<long> {
  ...
  static void read(std::ifstream &is, long &value) {
    std::string line;
    std::getline(is, line);
    value = specfem::io_backends::impl::ASCII::safe_parser<long>(
        line, [](const std::string &str) { return std::stol(str); });
  }
};

template <> struct specfem::io_backends::impl::ASCII::native_type<long long> {
  ...
  static void read(std::ifstream &is, long long &value) {
    std::string line;
    std::getline(is, line);
    value = specfem::io_backends::impl::ASCII::safe_parser<long long>(
        line, [](const std::string &str) { return std::stoll(str); });
  }
};

template <> struct specfem::io_backends::impl::ASCII::native_type<unsigned int> {
  ...
  static void read(std::ifstream &is, unsigned int &value) {
    std::string line;
    std::getline(is, line);
    value = specfem::io_backends::impl::ASCII::safe_parser<unsigned int>(
        line, [](const std::string &str) { return std::stoul(str); });
  }
};

template <> struct specfem::io_backends::impl::ASCII::native_type<unsigned long> {
  ...
  static void read(std::ifstream &is, unsigned long &value) {
    std::string line;
    std::getline(is, line);
    value = specfem::io_backends::impl::ASCII::safe_parser<unsigned long>(
        line, [](const std::string &str) { return std::stoul(str); });
  }
};

template <> struct specfem::io_backends::impl::ASCII::native_type<unsigned long long> {
  ...
  static void read(std::ifstream &is, unsigned long long &value) {
    std::string line;
    std::getline(is, line);
    value = specfem::io_backends::impl::ASCII::safe_parser<unsigned long long>(
        line, [](const std::string &str) { return std::stoull(str); });
  }
};

template <> struct specfem::io_backends::impl::ASCII::native_type<unsigned char> {
...
template <> struct specfem::io_backends::impl::ASCII::native_type<float> {
  static void write(std::ostream &os, const float &value) {
    os << std::setprecision(10) << std::scientific
       << specfem::io_backends::impl::ASCII::safe_real_writer(value) << "\n";
  }
  static void read(std::ifstream &is, float &value) {
    std::string line;
    std::getline(is, line);
    value = specfem::io_backends::impl::ASCII::safe_parser<float>(
        line, [](const std::string &str) { return std::stof(str); });
  }
};

template <> struct specfem::io_backends::impl::ASCII::native_type<double> {
  ...
  static void read(std::ifstream &is, double &value) {
    std::string line;
    std::getline(is, line);
    value = specfem::io_backends::impl::ASCII::safe_parser<double>(
        line, [](const std::string &str) { return std::stod(str); });
  }
};

template <> struct specfem::io_backends::impl::ASCII::native_type<std::string> {

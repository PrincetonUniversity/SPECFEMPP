...
public:
  ...
  using File =
      specfem::io_backends::impl::ASCII::File<OpType>; ///< ASCII file
                                                       ///< implementation
  using Group =
      specfem::io_backends::impl::ASCII::Group<OpType>; ///< ASCII group
                                                        ///< implementation
  template <typename ViewType>
  using Dataset =
      specfem::io_backends::impl::ASCII::Dataset<ViewType,
                                                 OpType>; ///< ASCII dataset
                                                          ///< implementation
};

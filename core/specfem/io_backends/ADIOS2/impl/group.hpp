...
public:
  ...
  specfem::io_backends::impl::ADIOS2::Dataset<ViewType, OpType>
  createDataset(const std::string &name, const ViewType data) {
    throw std::runtime_error("SPECFEM++ was not compiled with ADIOS2 support");
  }

  specfem::io_backends::impl::ADIOS2::Group<OpType>
...
public:
   ...
   * @return specfem::io_backends::impl::ADIOS2::Dataset<ViewType, OpType>
   * Dataset object
   */
  template <typename ViewType>
  specfem::io_backends::impl::ADIOS2::Dataset<ViewType, OpType>
   ...
   *
   * @param name Name of the group
   * @return specfem::io_backends::impl::ADIOS2::Group<OpType> Group object
   */
  specfem::io_backends::impl::ADIOS2::Group<OpType>
  createGroup(const std::string &name) {
    return specfem::io_backends::impl::ADIOS2::Group<OpType>(io_ptr, engine_ptr,
                                                             group_name, name);
  }

...
template <typename T>
specfem::io_backends::impl::ADIOS2::Dataset<ViewType, OpType>::Dataset(
  ...
  using native_type = specfem::io_backends::impl::ADIOS2::native_type<value_type>;
  variable =
...
specfem::io_backends::impl::ADIOS2::Dataset<ViewType, OpType>::write() {

  using native_t = specfem::io_backends::impl::ADIOS2::native_type<value_type>;
...
specfem::io_backends::impl::ADIOS2::Dataset<ViewType, OpType>::read() {

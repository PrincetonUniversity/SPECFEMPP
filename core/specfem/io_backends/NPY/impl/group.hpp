...
namespace specfem::io_backends::impl::NPY {
...
public:
   ...
   * @return specfem::io_backends::impl::NPY::Dataset<ViewType, OpType> Dataset
   * object
   */
  template <typename ViewType>
  specfem::io_backends::impl::NPY::Dataset<ViewType, OpType>
  createDataset(const std::string &name, const ViewType data) {
    return specfem::io_backends::impl::NPY::Dataset<ViewType, OpType>(
   ...
   * @return specfem::io_backends::impl::NPY::Group<OpType> Group object
   */
  specfem::io_backends::impl::NPY::Group<OpType>
  createGroup(const std::string &name) {
    return specfem::io_backends::impl::NPY::Group<OpType>(folder_path, name);
  }

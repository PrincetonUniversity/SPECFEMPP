...
specfem::io_backends::impl::HDF5::Dataset<ViewType, OpType>::Dataset(
...
template <typename ViewType, typename OpType>
void specfem::io_backends::impl::HDF5::Dataset<ViewType, OpType>::write() {
...
template <typename ViewType, typename OpType>
void specfem::io_backends::impl::HDF5::Dataset<ViewType, OpType>::read() {
  if (std::is_same_v<MemSpace, Kokkos::HostSpace>) {

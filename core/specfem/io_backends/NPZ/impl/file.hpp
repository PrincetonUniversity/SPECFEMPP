...
#include "specfem/io_backends/NPY/impl/npy_header.hpp"
#include <fstream>
#include <stdexcept>
#include <string>

namespace specfem::io_backends::impl::NPZ {
...
public:
  ...
  specfem::io_backends::impl::NPZ::Dataset<ViewType, OpType>
  createDataset(const std::string &name, const ViewType data) {
    throw std::runtime_error("SPECFEM++ was not compiled with NPZ support");
  }

  specfem::io_backends::impl::NPZ::Group<OpType>
...
#else
using NPYString = specfem::io_backends::impl::NPY::NPYString;
...
public:
   ...
   * @return specfem::io_backends::impl::NPZ::Dataset<ViewType, OpType> Dataset
   * object
   */
  template <typename ViewType>
  specfem::io_backends::impl::NPZ::Dataset<ViewType, OpType>
  createDataset(const std::string &path, const ViewType data) {
    return specfem::io_backends::impl::NPZ::Dataset<ViewType, OpType>(
        *this, path + ".npy", data);
  }
   ...
   * @return specfem::io_backends::impl::NPZ::Group<OpType> Group object
   */
  specfem::io_backends::impl::NPZ::Group<OpType>
  createGroup(const std::string &name) {
    return specfem::io_backends::impl::NPZ::Group<OpType>(*this, name);
  }

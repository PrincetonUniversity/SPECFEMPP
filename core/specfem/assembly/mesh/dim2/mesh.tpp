...
assign_numbering(specfem::kokkos::HostView4d<double> global_coordinates) {
  ...
  auto points = specfem::assembly::mesh_impl::dim2::flatten_coordinates(global_coordinates);
  ...
  type_real tolerance = specfem::assembly::mesh_impl::dim2::compute_spatial_tolerance(sorted_points, nspec, ngllxz);

  // Assign global numbering
  int nglob = specfem::assembly::mesh_impl::dim2::assign_global_numbering(sorted_points, tolerance);

  // Reorder points to original layout
  auto reordered_points = specfem::assembly::mesh_impl::dim2::reorder_to_original_layout(sorted_points);

  // Calculate bounding box using utilities
  auto bbox = specfem::assembly::mesh_impl::dim2::compute_bounding_box(reordered_points);

...
specfem::assembly::element_types<specfem::element::dimension_tag::dim3>::
    element_types(const int nspec, const int ngllz, const int nglly,
                  const int ngllx, MediumTagViewType medium_tags_,
...
void specfem::assembly::element_types<
    specfem::element::dimension_tag::dim3>::build_index_lists(){
  ...
  FOR_EACH_IN_PRODUCT((DIMENSION_TAG(DIM3), MEDIUM_TAG(ELASTIC, ACOUSTIC)),
                      CAPTURE(elements, h_elements) {
                        ...
                        _elements_ = IndexViewType(
                            "specfem::assembly::element_types::elements",
                            count);

 ...
 * external source. We implement it here instead of the source to remove
 * dependency of source on the assembly module.
 *
 * @param source The external source for which the source array is computed.

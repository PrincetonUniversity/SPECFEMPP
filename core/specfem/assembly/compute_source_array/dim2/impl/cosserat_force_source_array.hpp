 ...
 * Cosserat force source. We implement it here instead of the source to remove
 * dependency of source on the assembly module.
 *
 * @param source The Cosserat force source for which the source array is
 * computed.
 ...
 */
bool cosserat_force_source_array(

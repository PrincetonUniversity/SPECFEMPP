 ...
 *
 * Reads six face-direction sections from the binary database stream and
 * classifies faces into two groups:
 * - **absorbing_boundary**: faces in directions X_MIN, X_MAX, Y_MIN, Y_MAX,
 *   Z_MIN (boundary_numbers 1-5)
 * - **acoustic_free_surface**: faces in direction Z_MAX (boundary_number 6)
 *

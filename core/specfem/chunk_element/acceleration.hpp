 ...
 *
 * The specfem::chunk_element namespace provides specialized classes and
 * functions for high-performance, chunk-oriented processing of spectral element

...
KOKKOS_INLINE_FUNCTION void compute_coupling(
  ...
  self_field(0) = interface_data.face_factor *
                  (interface_data.face_normal(0) * coupled_field(0) +
                   interface_data.face_normal(1) * coupled_field(1) +
                   interface_data.face_normal(2) * coupled_field(2));
}
...
KOKKOS_INLINE_FUNCTION void compute_coupling(
  ...
  intersection_field(0) =
      ...
      (interface_data.face_normal(0) * self_mapped_field(0) +
       interface_data.face_normal(1) * self_mapped_field(1) +
       interface_data.face_normal(2) * self_mapped_field(2));
}

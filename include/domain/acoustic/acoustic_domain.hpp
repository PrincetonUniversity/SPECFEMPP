#ifndef _ACOUSTIC_DOMAIN_HPP
#define _ACOUSTIC_DOMAIN_HPP
...
/**
 * @brief Specialized domain class for acoustic media
 *
 * @tparam qp_type class used to define the quadrature points either at compile
 * time or run time
 */
template <typename qp_type>
class domain<specfem::enums::element::medium::acoustic, qp_type> {

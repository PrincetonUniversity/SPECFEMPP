...
//     specfem::wavefield::type::backward, DimensionType, MediumType,
//     PropertyTag, specfem::element::boundary_tag::stacey,
...
//                 specfem::enums::axes::x>(team_member),
//             [&](const int xz) {
//               int ix, iz;
//               sub2ind(xz, ngll, iz, ix);

//               const specfem::point::index<DimensionType> index(ispec_l, iz,
//               ix);

#ifndef _DOMAIN_SOURCE_ACOUSTIC2D_HPP
...
namespace sources {
/**
 * @brief Elemental source class for 2D acoustic media.
 *
 * Base class for all 2D acoustic elemental sources. This class contains pure

 ...
 */
template <>
class impl_material<specfem::element::medium_tag::electromagnetic_sv,
...
public:
  ...
  impl_material(type_real mu0, type_real e0, type_real e11, type_real e33,
                ...
                type_real Qe33, type_real Qs11, type_real Qs33)
   ...
   */
  bool operator==(
      const impl_material<specfem::element::medium_tag::electromagnetic_sv,
                          specfem::element::property_tag::isotropic> &other)
      const {
...
/**
 * @brief Template specialization for electromagnetic isotropic (SH) material
 * properties
 *
 */
template <>
class impl_material<specfem::element::medium_tag::electromagnetic_sh,
                    specfem::element::property_tag::isotropic> {
public:
  constexpr static auto dimension =
      specfem::dimension::type::dim2; ///< Dimension of the material
   ...
   */
  bool operator==(
      const impl_material<specfem::element::medium_tag::electromagnetic_sh,
                          specfem::element::property_tag::isotropic> &other)
      const {
   ...
   * @return specfem::point::properties Material properties
   */
  // TODO: Add the properties for electromagnetic_sh
  // inline specfem::point::properties<dimension, medium_tag, property_tag,
  // false> get_properties() const {
  //   return { this->mu0, this->e0, this->e11, this->e33, this->sig11,
  //   this->sig33,

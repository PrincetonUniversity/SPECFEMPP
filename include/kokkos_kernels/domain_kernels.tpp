...
namespace specfem::kokkos_kernels {
template <specfem::wavefield::simulation_field WavefieldType, int NGLL>
class domain_kernels<WavefieldType, specfem::dimension::type::dim2, NGLL> {
public:
...
template <specfem::wavefield::simulation_field WavefieldType, int NGLL>
class domain_kernels<WavefieldType, specfem::dimension::type::dim3, NGLL> {
public:

...
struct adjacency_pointer{
  ...
  KOKKOS_INLINE_FUNCTION
  adjacency_pointer(int elem, specfem::enums::boundaries::type side, bool flip = false): 
...
public:
  ...
  adjacency_graph(int nspec): nspec(nspec){
    adjacencies =
        Kokkos::View<specfem::adjacency_graph::adjacency_pointer * [num_sides], Kokkos::LayoutLeft,
  ...
  void clear_adjacency(int elem, int8_t side){
    ...
    specfem::adjacency_graph::adjacency_pointer neighbor = h_adjacencies(elem,side);
    if(neighbor.is_active()){
      h_modified = true;
      h_adjacencies(neighbor.elem,neighbor.side) = specfem::adjacency_graph::adjacency_pointer();
  ...
  void form_adjacency(int elem_a, int8_t side_a, int elem_b, int8_t side_b, bool flip = false){
  ...
  void form_adjacency(specfem::adjacency_graph::adjacency_pointer a,
                      specfem::adjacency_graph::adjacency_pointer b, bool flip = false){
    form_adjacency(a.elem, a.side, b.elem, b.side, flip);
  }

  specfem::adjacency_graph::adjacency_pointer get_adjacency(int elem, int8_t side) const{
    if(modified)
      Kokkos::deep_copy(h_adjacencies, adjacencies);

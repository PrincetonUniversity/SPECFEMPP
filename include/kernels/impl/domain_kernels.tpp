...
template <specfem::wavefield::simulation_field WavefieldType,
          specfem::dimension::type DimensionType, int NGLL>
template <specfem::element::medium_tag MediumTag>
void specfem::kernels::impl::domain_kernels<WavefieldType, DimensionType,
                                            NGLL>::divide_mass_matrix() {
...
template <specfem::element::medium_tag MediumTag>
void specfem::kernels::impl::domain_kernels<
    WavefieldType, DimensionType, NGLL>::invert_mass_matrix(const type_real
                                                                &dt) {
...
template <specfem::element::medium_tag MediumTag,
          ...
          specfem::element::boundary_tag BoundaryTag>
void specfem::kernels::impl::domain_kernels<
    WavefieldType, DimensionType, NGLL>::compute_mass_matrix(const type_real
                                                                 &dt) {
  ...
  using PointMassType =
      specfem::point::field<dimension, medium_tag, false, false, false, true, using_simd>;

  using PointPropertyType =
      specfem::point::properties<dimension, medium_tag, property_tag, using_simd>;

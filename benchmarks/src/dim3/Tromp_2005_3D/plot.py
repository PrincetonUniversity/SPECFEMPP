...
def plot_kernels(input_directory, output):
    X, Y, Z, rho, kappa, mu, rhop, alpha, beta = load_data(input_directory)
    ...
    plot_data(ax[0, 0], X_grid, Z_grid, data["mu"], r"$\kappa_\mu$", cmap)
    plot_data(ax[0, 1], X_grid, Z_grid, data["beta"], r"$\kappa_\beta$", cmap)
    plot_data(ax[1, 0], X_grid, Z_grid, data["kappa"], r"$\kappa_\kappa$", cmap)
    plot_data(ax[1, 1], X_grid, Z_grid, data["alpha"], r"$\kappa_\alpha$", cmap)
    plot_data(ax[2, 0], X_grid, Z_grid, data["rho"], r"$\kappa_\rho$", cmap)
    plot_data(ax[2, 1], X_grid, Z_grid, data["rhop"], r"$\kappa_\rho'$", cmap)

...
std::unordered_map<std::string, size_t> expected_nelements = {
  { "HomogeneousMediumMPI4x4", 16 }
}; /// 4x4x1 mesh with 16 elements total

TEST_P(Read3DMeshMPITest, SuccessfulExecution) {

...
TYPED_TEST(PointJacobianMatrixTest, JacobianMatrix2D_WithJacobian_Inverse) {
  constexpr bool using_simd = TypeParam::value;
...
TYPED_TEST(PointJacobianMatrixTest, JacobianMatrix3D_WithJacobian_Inverse) {
  constexpr bool using_simd = TypeParam::value;
  ...
  typename specfem::datatype::simd<type_real, using_simd>::datatype a_etax_val{
    2.0
  };
  typename specfem::datatype::simd<type_real, using_simd>::datatype
      a_gammax_val{ 3.0 };
  typename specfem::datatype::simd<type_real, using_simd>::datatype a_xiy_val{
    4.0
  };
  typename specfem::datatype::simd<type_real, using_simd>::datatype a_etay_val{
    5.0
  };
  typename specfem::datatype::simd<type_real, using_simd>::datatype
      a_gammay_val{ 6.0 };
  ...
  typename specfem::datatype::simd<type_real, using_simd>::datatype a_etaz_val{
    8.0
  };
  typename specfem::datatype::simd<type_real, using_simd>::datatype
      a_gammaz_val{ 10.0 };
  ...
  using PD = point::jacobian_matrix<specfem::element::dimension_tag::dim3, true,
                                    using_simd>;
  PD a(a_xix_val, a_etax_val, a_gammax_val, a_xiy_val, a_etay_val, a_gammay_val,
       a_xiz_val, a_etaz_val, a_gammaz_val, a_jacobian_val);
  // Inversion
  PD a_inv = a.inverse();
  // Inverse of this matrix is
  // [-2/3 -4/3  1]
  ...
  EXPECT_TRUE(specfem::utilities::is_close(
      ...
      << ExpectedGot(static_cast<typename PD::value_type>(-2.0 / 3.0),
                     a_inv.xix);
  EXPECT_TRUE(specfem::utilities::is_close(
      a_inv.etax, static_cast<typename PD::value_type>(-4.0 / 3.0)))
      << ExpectedGot(static_cast<typename PD::value_type>(-4.0 / 3.0),
                     a_inv.etax);
  EXPECT_TRUE(specfem::utilities::is_close(
      a_inv.gammax, static_cast<typename PD::value_type>(1.0)))
      << ExpectedGot(static_cast<typename PD::value_type>(1.0), a_inv.gammax);
  EXPECT_TRUE(specfem::utilities::is_close(
      a_inv.xiy, static_cast<typename PD::value_type>(-2.0 / 3.0)))
      << ExpectedGot(static_cast<typename PD::value_type>(-2.0 / 3.0),
                     a_inv.xiy);
  EXPECT_TRUE(specfem::utilities::is_close(
      a_inv.etay, static_cast<typename PD::value_type>(11.0 / 3.0)))
      << ExpectedGot(static_cast<typename PD::value_type>(11.0 / 3.0),
                     a_inv.etay);
  EXPECT_TRUE(specfem::utilities::is_close(
      a_inv.gammay, static_cast<typename PD::value_type>(-2.0)))
      << ExpectedGot(static_cast<typename PD::value_type>(-2.0), a_inv.gammay);
  EXPECT_TRUE(specfem::utilities::is_close(
      a_inv.xiz, static_cast<typename PD::value_type>(1.0)))
      << ExpectedGot(static_cast<typename PD::value_type>(1.0), a_inv.xiz);
  EXPECT_TRUE(specfem::utilities::is_close(
      a_inv.etaz, static_cast<typename PD::value_type>(-2.0)))
      << ExpectedGot(static_cast<typename PD::value_type>(-2.0), a_inv.etaz);
  EXPECT_TRUE(specfem::utilities::is_close(

...
//   using PD = point::jacobian_matrix<specfem::element::dimension_tag::dim3,
//   true,
//                                     using_simd>;
//   PD a(a_xix_val, a_etax_val, a_gammax_val, a_xiy_val, a_etay_val,
//   a_gammay_val,
...
//   EXPECT_TRUE(specfem::utilities::is_close(
//       a_inv.gammax, static_cast<typename PD::value_type>(1.0)))
//       << ExpectedGot(static_cast<typename PD::value_type>(1.0),
//       a_inv.gammax);
//   EXPECT_TRUE(specfem::utilities::is_close(
...
//       << ExpectedGot(static_cast<typename PD::value_type>(-2.0),
//       a_inv.gammay);
//   EXPECT_TRUE(specfem::utilities::is_close(

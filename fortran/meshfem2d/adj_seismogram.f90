...
program adj_seismogram
   ...
   character(len=150) :: filename, synthetics_folder, adjoint_sources_folder
   ...
   do i = 1,6
      ...
      if (trim(arg) == '' .or. command_argument_count() /= 6) then
         print *,'Usage: '
         ...
         print *,'  synthetics-folder = folder containing the seismograms'
         print *,'  adjoint-sources-folder = folder to store adjoint sources'
      ...
      select case (i)
       ...
       case (4)
         synthetics_folder = trim(arg)
       case (5)
         adjoint_sources_folder = trim(arg)
       case (6)

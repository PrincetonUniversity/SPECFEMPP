...
!  use source_file_par
   ...
   if (myrank == 0) then
      ...
      if (read_external_mesh) then
         ! @Kentaro Here you should be calling routine to read in adjacency information generated by external mesher
      else
         ! computes adjacency information for internal mesh

...
.. note::
    ...
    Please note, in this cookbooks we refer to this package as ``SPECFEM2D Kokkos`` and the `fortran version <https://specfem2d.readthedocs.io/en/latest/>`_ as ``SPECFEM2D``.
